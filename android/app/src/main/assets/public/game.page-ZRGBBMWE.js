...
function GamePageComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-sleep-overlay", 5);
...
function GamePageComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-parental-gate", 6);
...
function GamePageComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 7)(2, "h2", 8);
    \u0275\u0275text(3, "\xBFQu\xE9 deseas hacer?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 9);
    \u0275\u0275text(5, "Verificaci\xF3n completada con \xE9xito");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, GamePageComponent_Conditional_6_Conditional_6_Template, 2, 0, "ion-button", 10)(7, GamePageComponent_Conditional_6_Conditional_7_Template, 2, 0, "ion-button", 10);
    \u0275\u0275elementStart(8, "ion-button", 11);
...
function GamePageComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, GamePageComponent_Conditional_7_Conditional_2_Template, 2, 0, "div", 14);
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 19)(11, "span", 17);
...
var _GamePageComponent = class _GamePageComponent {
  ...
  initPhaserGame() {
    return __async(this, null, function* () {
      const { createPhaserGame } = yield import("./game-VVCYPW32.js");
      const s = this.settings.settings();
      const mode = this.gameState.mode();
      const savedState = this.save.hasSavedGame(mode) ? this.save.progress().savedGame : void 0;
      if (savedState) {
      ...
      this.phaserGame.events.on("bms:game-over", () => {
        ...
        const mode2 = this.gameState.mode();
        const elapsed = this.gameState.elapsedTime();
        const isNew = score > (this.save.progress().highScores[mode2] ?? 0);
        this.save.updateHighScore(mode2, score);
        this.save.recordGameEnd(elapsed);
        this.isNewRecord.set(isNew);
        this.isGameOver.set(true);
        this.sync.submitScore(score, mode2, elapsed);
      });
    });
  }
  onOpenGate() {
...
}, decls: 9, vars: 5, consts: [["phaserContainer", ""], [3, "backClicked"], [1, "phaser-host"], ["role", "dialog", 1, "overlay-dialog"], [1, "readonly-banner"], [3, "openGate"], [3, "unlocked", "dismissed"], [1, "dialog-card"], [1, "dialog-title"], [1, "dialog-subtitle"], ["expand", "block", "color", "primary"], ["expand", "block", "fill", "outline", "color", "medium", 3, "click"], ["expand", "block", "color", "primary", 3, "click"], [1, "gameover-card"], ["aria-live", "polite", 1, "record-badge"], [1, "gameover-title"], [1, "score-section"], [1, "score-label"], [1, "score-value"], [1, "hiscore-section"], [1, "hiscore-value"], [1, "readonly-back", 3, "click"]], template: function GamePageComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275conditionalCreate(6, GamePageComponent_Conditional_6_Template, 10, 1, "div", 3);
    \u0275\u0275conditionalCreate(7, GamePageComponent_Conditional_7_Template, 21, 3, "div", 3);
    \u0275\u0275conditionalCreate(8, GamePageComponent_Conditional_8_Template, 4, 0, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
...
//# sourceMappingURL=game.page-ZRGBBMWE.js.map
