...
function LeaderboardPageComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 10);
    \u0275\u0275listener("click", function LeaderboardPageComponent_For_10_Template_button_click_0_listener() {
...
function LeaderboardPageComponent_Conditional_13_For_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("lb-row--top", \u0275$index_33_r5 < 3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275$index_33_r5 + 1);
    \u0275\u0275advance(2);
...
function LeaderboardPageComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ol", 7);
    \u0275\u0275repeaterCreate(1, LeaderboardPageComponent_Conditional_13_For_2_Template, 7, 5, "li", 11, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var _LeaderboardPageComponent = class _LeaderboardPageComponent {
  ...
  load() {
    return __async(this, null, function* () {
      ...
      this.entries.set(yield this.sync.fetchChallengeRanking(`global-${this.selectedMode()}`));
...
_LeaderboardPageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LeaderboardPageComponent, selectors: [["app-leaderboard-page"]], decls: 17, vars: 1, consts: [["slot", "start"], [3, "click"], ["slot", "icon-only", "name", "arrow-back-outline"], [1, "lb-content"], [1, "lb-tabs"], [1, "lb-tab", 3, "lb-tab--active"], [1, "lb-empty"], [1, "lb-list"], [1, "lb-refresh"], ["fill", "outline", "size", "small", 3, "click"], [1, "lb-tab", 3, "click"], [1, "lb-row", 3, "lb-row--top"], [1, "lb-row"], [1, "lb-pos"], [1, "lb-name"], [1, "lb-score"]], template: function LeaderboardPageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0)(3, "ion-button", 1);
    \u0275\u0275listener("click", function LeaderboardPageComponent_Template_ion_button_click_3_listener() {
      return ctx.goBack();
    });
    \u0275\u0275element(4, "ion-icon", 2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "ion-title");
    \u0275\u0275text(6, "Ranking Global");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "ion-content", 3)(8, "div", 4);
    \u0275\u0275repeaterCreate(9, LeaderboardPageComponent_For_10_Template, 2, 3, "button", 5, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, LeaderboardPageComponent_Conditional_11_Template, 2, 0, "p", 6)(12, LeaderboardPageComponent_Conditional_12_Template, 2, 0, "p", 6)(13, LeaderboardPageComponent_Conditional_13_Template, 3, 0, "ol", 7);
    \u0275\u0275elementStart(14, "div", 8)(15, "ion-button", 9);
    \u0275\u0275listener("click", function LeaderboardPageComponent_Template_ion_button_click_15_listener() {
      return ctx.load();
    });
    \u0275\u0275text(16, "Actualizar");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.loading() ? 11 : ctx.entries().length === 0 ? 12 : 13);
  }
}, dependencies: [
  CommonModule,
  IonContent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LeaderboardPageComponent, { className: "LeaderboardPageComponent", filePath: "src/app/pages/leaderboard/leaderboard.page.ts", lineNumber: 17 });
})();
export {
  LeaderboardPageComponent
};
//# sourceMappingURL=leaderboard.page-WFLCPJLQ.js.map
