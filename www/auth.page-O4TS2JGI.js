...
function AuthPageComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "ion-button", 6);
    \u0275\u0275listener("click", function AuthPageComponent_Conditional_9_Template_ion_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
...
function AuthPageComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ion-button", 9);
    \u0275\u0275listener("click", function AuthPageComponent_Conditional_10_Template_ion_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
_AuthPageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthPageComponent, selectors: [["app-auth-page"]], decls: 11, vars: 1, consts: [["slot", "start"], [3, "click"], ["slot", "icon-only", "name", "arrow-back-outline"], [1, "auth-content"], [1, "auth-card"], [1, "auth-name"], ["expand", "block", "fill", "outline", "color", "danger", 3, "click"], [1, "auth-title"], [1, "auth-sub"], ["expand", "block", 3, "click"]], template: function AuthPageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0)(3, "ion-button", 1);
    \u0275\u0275listener("click", function AuthPageComponent_Template_ion_button_click_3_listener() {
      return ctx.goBack();
    });
    ...
    \u0275\u0275conditionalCreate(9, AuthPageComponent_Conditional_9_Template, 4, 1)(10, AuthPageComponent_Conditional_10_Template, 6, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(9);
    \u0275\u0275conditional(ctx.auth.isAuthenticated() ? 9 : 10);
  }
}, dependencies: [
  CommonModule,
  IonContent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthPageComponent, { className: "AuthPageComponent", filePath: "src/app/pages/auth/auth.page.ts", lineNumber: 17 });
})();
export {
  AuthPageComponent
};
//# sourceMappingURL=auth.page-O4TS2JGI.js.map
